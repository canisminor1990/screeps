...
Mineral.prototype.hasExtractor = function(): boolean {
  ...
  for (let s of structures) {
    if (s instanceof StructureExtractor) {
      return true;
    }
  }
  return false;
...
Mineral.prototype.getMiningContainer = function(): StructureContainer | null {
  this.memoryCheck();
  ...
  let container = Game.getObjectById(Memory.minerals[this.id]['container']) as StructureContainer;
  if (container === null) {
