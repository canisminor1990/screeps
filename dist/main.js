...
exports.default = function (roomName) {
	...
	room.visual.rect(1, 1.2, 8, 0.8, { fill: 'rgba(255,255,255,.2)', opacity: 1 }).rect(1, 1.2, 8 / gcl.progressTotal * gcl.progress, 0.8, { fill: colorType.blue, opacity: 1 }).text('GCL | lv' + gcl.level, 1, 1, { font: 0.5, align: 'left', opacity: 1 });
};
