...
exports.default = function (roomName) {
	...
	room.visual.circle(1, 1, { radius: .6, fill: 'rgba(0,0,0,.5)', stroke: colorType.blue, strokeWidth: .1, opacity: 1 }).text('GCL', 1, 1, { color: colorType.blue, font: 0.25 }).text(gcl.level, 1, 1.2, { color: colorType.blue });
};
