...
exports.default = function (roomName) {
	...
	room.visual.rect(1, 1.1, 1, 0.2, { fill: '#000' }).rect(1, 1.1, 1 / gcl.progressTotal * gcl.progress, 0.2, { fill: '#66D9EF', opacity: 1 }).text('GCL: ' + gcl.level, 1, 1, { font: 0.8, align: 'left' });
};
