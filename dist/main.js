...
exports.default = function (room) {
    var Memory = room.memory;
    var roomNext = Game.rooms['W81S66'] ? Game.rooms['W81S66'].memory.structures.my : null;
    var targetStructures = Memory.structures;
...
exports.default = function (creep, needBuild, newRoom) {
	...
	if (needBuild.length > 0) {
		...
		if (creep.memory.canBuild && newNeedBuild.length > 0) {
			...
			_buildTarget && creep.build(_buildTarget) != OK ? (0, _task.pathFinder)(creep, _buildTarget) : (0, _task.pathFinder)(creep, _buildTarget);
		} else {
...
exports.default = function (creep) {
  ...
  var test = Game.getObjectById('58d07b35bfeec6256575be5d');
