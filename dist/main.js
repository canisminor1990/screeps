...
exports.default = function (roomName) {
	...
	room.visual.rect(guiCreepX - bgPadding, guiCreepY - 2 * bgPadding, guiCreepWidth + 2 * bgPadding, 10 * (guiCreepHeight + guiCreepRowMargin) - 2 * guiCreepRowMargin + 2 * bgPadding, {
		fill: 'rgba(0,0,0,.5)',
		opacity: 0.5,
		stroke: '#000',
		strokeWidth: 0.05
